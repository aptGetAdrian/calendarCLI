...
func getClient(config *oauth2.Config) (*http.Client, error) {
	...
	if err != nil {
		...
		return config.Client(context.Background(), tok), fmt.Errorf("You are alredy authenticated and have your access and refresh tokens stored in a \"tokens.json\" file\n")
	}
